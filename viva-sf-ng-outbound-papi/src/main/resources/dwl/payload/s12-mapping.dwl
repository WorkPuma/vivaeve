    ...
    "Data": {
        "SIU_S12": {
            ...
            "MSH": {
                ...
                "MSH-09": {
                    "CM_MSG-02": p('mshsegment.MSH-09-MSG-02-s12'),
                    "CM_MSG-01": p('mshsegment.MSH-09-MSG-01')
                }
            },
            "SCH": {
                "SCH-02": {
                    "EI-01": if(payload.data.payload.Status == "Scheduled") (payload.data.payload.ChangeEventHeader.recordIds[0]) else (payload.data.payload.ChangeEventHeader.recordIds[0])
                },
                "SCH-11": [
                    {
                         "TQ-05": {
...
//                },
                "SCH-25": {
                   "CE_0278-01": if (payload.data.payload.Status? and payload.data.payload.Status != null and payload.data.payload.Status == "Scheduled") "Booked" else null
                },
