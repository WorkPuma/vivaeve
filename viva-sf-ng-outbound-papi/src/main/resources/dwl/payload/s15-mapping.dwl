...
//                },
                "SCH-25": {
                    "CE_0278-01": if (payload.data.payload.Status? and payload.data.payload.Status != null and payload.data.payload.Status == "Cancelled by Patient" or payload.data.payload.Status == "Cancelled by Provider") "Cancelled" else if (payload.data.payload.Status == "No Show") "No Show" else null
                },
 ...
 //                      ]
  //                 }
            ...
            "NTE": [
                {
                    "NTE-03": [
                        (payload.data.payload.CancellationReason) if ((payload.data.payload.CancellationReason?) and (payload.data.payload.CancellationReason != null))
                    ]
                }
            ]
        }
