...
"Data": {
        "ADT_A04": {
            "MSH": {
                ...
                "MSH-09": {
                    "CM_MSG-02": p('mshsegment.MSH-09-MSG-02-A04'),
...
//                    "GT1-09":  if ((payload.data.payload.Guarantor_Gender__c?) and (payload.data.payload.Guarantor_Gender__c != null)) 
...
//                        }
                ...
                "PID-05": [
                    {
                        ...
                        ("XPN-02": payload.data.payload.Name.FirstName replace /[^a-zA-Z]/ with "") if ((payload.data.payload.Name.FirstName?) and (payload.data.payload.Name.FirstName != null)),
                        ("XPN-03": payload.data.payload.Name.MiddleName replace /[^a-zA-Z]/ with "") if ((payload.data.payload.Name.MiddleName?) and (payload.data.payload.Name.MiddleName != null)),
                        ("XPN-01": payload.data.payload.Name.LastName replace /[^a-zA-Z]/ with "") if ((payload.data.payload.Name.LastName?) and (payload.data.payload.Name.LastName != null))
                    }
                ],
                "PID-04": [
                    {
 ...
 //               "PID-03": [
  //                  {
  //                      ("CX-01": payload.data.payload.HF_Chart_Number__c) if ((payload.data.payload.HF_Chart_Number__c?) and (payload.data.payload.HF_Chart_Number__c != null))
   //                 }
   //             ],
 //               "PID-02": {
  //                    ("CX-01": payload.data.payload.ChangeEventHeader.recordIds[0]) if ((payload.data.payload.ChangeEventHeader.recordIds[0]?) and (payload.data.payload.ChangeEventHeader.recordIds[0] != null))
               ...
               "PID-13": [
                    {
                     ...
                     "XTN-04":  if ((payload.data.payload.Email) != null and (payload.data.payload.Email?)) payload.data.payload.Email else ("tahmed@vivaeve.com"),
					 "XTN-01": if ((payload.data.payload.Phone) != null and (payload.data.payload.Phone?)) payload.data.payload.Phone else ("212.988.2111")
                    }
                ],
                "PID-01": 1,
                "PID-12": "+1",
                ...
                "PID-10": if ((payload.data.payload.Patient_Race__c) != null and (payload.data.payload.Patient_Race__c?)) payload.data.payload.Patient_Race__c else ("White"),
                "PID-08": if ((payload.data.payload.Patient_Gender_2__c?) and (payload.data.payload.Patient_Gender_2__c != null)) if (payload.data.payload.Patient_Gender_2__c == "Female") "F" else if (payload.data.payload.Patient_Gender_2__c == "Male") "M" else payload.data.payload.Patient_Gender_2__c else "F",
                "PID-07": {
                	
                      "TS-01":  if ((payload.data.payload.Date_of_Birth__c?) and (payload.data.payload.Date_of_Birth__c != null)) (payload.data.payload.Date_of_Birth__c as Date {format: "yyyy-MM-dd"} as String {format: "yyyyMMdd"}) else ("19000101")
                }
            },
      //     "PV1": {
      //        "PV1-02": "O",
