    ...
    "Data": {
        "SIU_S13": {
            ...
            "MSH": {
                ...
                "MSH-09": {
                    "CM_MSG-02": p('mshsegment.MSH-09-MSG-02-s13'),
...
//                },
                "SCH-25": {
                    "CE_0278-01": if (payload.data.payload.Status? and payload.data.payload.Status != null and payload.data.payload.Status == "Rescheduled by Patient" or payload.data.payload.Status == "Rescheduled by Provider") "Rescheduled" else null
                },
                ...
                "PID-11": [
                    {
                      ...
                      "XAD-01":  if ((vars.queryData[0].MailingStreet) != null and (vars.queryData[0].MailingStreet?)) vars.queryData[0].MailingStreet else ("63rd Road")
                        ...
                        "PID-10": if ((vars.queryData[0].Patient_Race__c) != null and (vars.queryData[0].Patient_Race__c?)) vars.queryData[0].Patient_Race__c else ("White"),
